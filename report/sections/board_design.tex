...
Much has happened in manufacturing since then. 
The original data does not take into account the possibility of multi-layered boards or different board materials.
In 2009 the new IPC-2152 \cite{ipc2152} was published and reevaluates the topic of current-carrying capacity.
This standard, however, is unavailable due to its high cost.
...
One such calculator was used to determine the required copper thickness and width required in this project.
~\\
...
\begin{itemize}
	...
	The manufacturer is capable of creating traces at 6 mil or higher and as such the trace width for this type is 6 mil.
