...
\paragraph{Conclusion}~\\
The \texttt{nRFM} was included in the joint board PCB and wired to the \texttt{ATtiny84}.
...
While developing software for the \texttt{ATtiny84} it was revealed that the \texttt{74LCX244} and \texttt{ATtiny84} both attempt to drive the \texttt{SCLK} and \texttt{MOSI} nets, resulting in the communication with the \texttt{nRFM} not functioning.
