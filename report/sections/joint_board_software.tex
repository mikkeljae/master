...
\end{tabular}
\caption{Number of received packets out of 10000 transmitted. The pendulum was held still during the test.}
...
\end{tabular}
\caption{Number of received packets out of 10000 transmitted. The pendulum was moved during the test.}
...
\begin{figure}[h]
	...
	\caption{IDs of received packages plotted. ID corresponds to the number of milliseconds passed since program start.}
