...
\thomas{done - introduction to section}
...
\mikkel{both flowcharts need doing!}
\begin{figure}[h]
	\centering
...
The number of received packets can be seen in the \textbf{S} row in table \ref{tab:received_still}.
\thomas{done - table experimentation, remember to fix text}
\begin{table}[h]
\centering
\resizebox{\textwidth}{!}{
