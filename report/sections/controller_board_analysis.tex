...
\begin{itemize}
	...
	\thomas{note in verification that a protocol DOES exist in the RF module.}
\end{itemize}
...
\thomas{generate requirement for current mode control}
...
\begin{enumerate}[resume]
	...
	\begin{itemize}
		\item Shunt resistor to allow for measurement of the motor current.
	\end{itemize}
