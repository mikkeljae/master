...
\begin{figure}[h]
	...
	\caption[SPI communication between nRF24 and the MicroZed]{SPI communication between \texttt{nRF24} and the MicroZed. Shown is a write command of \texttt{RF\_CONFIG} register, \texttt{0x00}. The value written to the \texttt{RF\_CONFIG} register is \texttt{0b00110101}. 2 bytes are exchanged in total.}
	\label{fig:nrf24_spi}
\end{figure}
\mikkel{Make a comment about SPI freq. It was measured using a lower F to make nice plot....}
