...
\thomas{done - refactor joint design section}
...
This section will consists of a presentation of the designed components.
\\~\\
...
It is calculated that $\approx$98.9\% of the battery capacity can be utilized.
...
The disadvantage of using a Buck converter is that the full battery capacity cannot be utilized, but a test showed that $\approx$98.9\% of the capacity can be used.
\thomas{done - calculate actual utilizable capacity}
