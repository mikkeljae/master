...
\mikkel{Should be in this section somehow}
...
\mikkel{Rolin should not be discussed here}
...
\mikkel{Because of DCDC converter for 12V rail it was decided to use 4 Ohm (4.7Ohm) resistor to limit the charge current. The max dutycycle should be recalculated.}
...
\paragraph{Copper Layout} % (fold)
\label{par:copper_layout}
...
\begin{figure}
	\centering
	\includegraphics[width=.5\linewidth]{graphics/power_layout}
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\caption{Copper layout of the power part on the top layer.}
		\label{sfig:power_layout}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=\linewidth]{graphics/power_layout_3}
