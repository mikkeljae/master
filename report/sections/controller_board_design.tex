...
\begin{table}[h]
	...
	\hline
	\end{tabular}
	\caption[Relevant parameters of the IRF100B202 MOSFET.]{Relevant parameters of the IRF100B202 MOSFET \cite{mosfet} chosen for the full-bridge.
...
\begin{table}[tb]
	...
	\end{tabular}
	\caption[Relevant parameters of the \texttt{MAL215099911E3} capacitor.]{Relevant parameters of the \texttt{MAL215099911E3} capacitor \cite{sup_cap}.
...
The main relay should be able to carry and break the total design current, 80A.
...
The circuitry is identical for the main relay.
