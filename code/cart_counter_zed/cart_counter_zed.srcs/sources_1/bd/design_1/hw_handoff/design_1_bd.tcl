...
proc create_root_design { parentCell } {
  ...
  # Create instance: cart_counter_v3_0, and set properties
  set cart_counter_v3_0 [ create_bd_cell -type ip -vlnv user.org:user:cart_counter_v3:1.0 cart_counter_v3_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins cart_counter_v3_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net A_1 [get_bd_ports A] [get_bd_pins cart_counter_v3_0/A]
  connect_bd_net -net B_1 [get_bd_ports B] [get_bd_pins cart_counter_v3_0/B]
  connect_bd_net -net Z_1 [get_bd_ports Z] [get_bd_pins cart_counter_v3_0/Z]
  connect_bd_net -net cart_counter_v3_0_led [get_bd_ports led] [get_bd_pins cart_counter_v3_0/led]
  connect_bd_net -net emend_1 [get_bd_ports emend] [get_bd_pins cart_counter_v3_0/emend]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins cart_counter_v3_0/clk] [get_bd_pins cart_counter_v3_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins cart_counter_v3_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs cart_counter_v3_0/S00_AXI/S00_AXI_reg] SEG_cart_counter_v3_0_S00_AXI_reg
